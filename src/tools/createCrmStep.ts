...
Parameters:
- \`scenarioId\` (string, required): The ID of the CRM scenario to add the step to.
- \`name\` (string, required): The name for the new CRM step.
- \`description\` (string): An optional description for the CRM step.
